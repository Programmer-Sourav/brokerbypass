...
export default function PropertyListItem(){
    ...
    return(
        <div className="card-parent">
            <p className="property-title-default">{foundDetails && foundDetails.flatName}2 BHK House For Rent In J.P. Nagar</p>
            <p className="propery-description-default"><span>{foundDetails && foundDetails.flatAddress}Independent House, Bannerghatta main road near the Thai Spa(Vega City Mall) </span> <span className="propery-description-default">Explore nearby</span></p>
            <div className="room-details-price">
                <div className="room-details-inner-component">
                    <p>{foundDetails && foundDetails.flatRent}₹15,000</p>
                    <p className="propery-description-default">Rent (negotiable)</p>
                </div>
                <div className="room-details-inner-component">
                <p>{foundDetails && foundDetails.flatDeposit}₹80,000</p>
                <p className="propery-description-default">Deposit</p>
                </div>
                <div className="room-details-inner-component">
                <p>{foundDetails && foundDetails.flatMeasures}600 sqft</p>
                ...
                <div class="grid-container">
                 <div class="grid-item">
                    <p className="property-grid-title">{foundDetails && foundDetails.furnishedStatus}Semi Furnished</p>
                    <p className="propery-description-default">Furnishing</p>
                 </div>
                 <div class="grid-item">
                 <p className="property-grid-title">{foundDetails && foundDetails.apartmentType}2 BHK</p>
                 <p className="propery-description-default">Apartment Type</p>
                 </div>
                 <div class="grid-item">
                 <p className="property-grid-title">{foundDetails && foundDetails.preferredTenets}All</p>
                 <p className="propery-description-default">Preferred Tenets</p>
                 </div>
                 <div class="grid-item">
                 <p className="property-grid-title">{foundDetails && foundDetails.availableFrom}Ready To Move</p>
